...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  // ==========================================
  // 1. GOOGLE FAST AUTH (THE ONLY ACTIVE LOGIN)
  // ==========================================
  ...
  // ==========================================
  // 2. TELEGRAM (DISABLED IN DEV MODE)
  // ==========================================
  const handleTelegramClick = () => {
    setSuccessMessage('');
    setErrorMessage(
      isKg
        ? 'Сайт даярдоо процессинде: Telegram аркылуу кирүү азырынча иштебейт. Сураныч, Google аркылуу кириңиз.'
        : 'Сайт в процессе подготовки: вход через Telegram пока не работает. Пожалуйста, используйте вход через Google.'
    );
  };
  ...
  const handleWhatsAppClick = () => {
    ...
    setErrorMessage(
      isKg
        ? 'Сайт даярдоо процессинде: WhatsApp аркылуу кирүү азырынча иштебейт. Сураныч, Google аркылуу кириңиз.'
        : 'Сайт в процессе подготовки: вход через WhatsApp пока не работает. Пожалуйста, используйте вход через Google.'
    );
  };
  ...
  const handleEmailFormSubmit = (e: React.FormEvent) => {
    ...
    setErrorMessage(
      isKg
        ? 'Сайт даярдоо процессинде: Почтадагы 6 орундуу код аркылуу кирүү азырынча иштебейт. Сураныч, Google аркылуу кириңиз.'
        : 'Сайт в процессе подготовки: вход через 6-значный код почты пока не работает. Пожалуйста, используйте вход через Google.'
    );
  };
  ...
  const handlePhoneFormSubmit = (e: React.FormEvent) => {
    ...
    setErrorMessage(
      isKg
        ? 'Сайт даярдоо процессинде: SMS-код аркылуу кирүү азырынча иштебейт. Сураныч, Google аркылуу кириңиз.'
        : 'Сайт в процессе подготовки: вход по SMS-коду пока не работает. Пожалуйста, используйте вход через Google.'
    );
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      ...
      >
        ...
        {showDevNotice && (
          <div className="mb-4 p-3.5 rounded-2xl bg-gradient-to-r from-amber-950/70 via-amber-900/40 to-amber-950/70 border border-amber-500/50 text-amber-200 text-xs shadow-lg relative animate-in fade-in duration-200">
            <button
              type="button"
              onClick={() => setShowDevNotice(false)}
              className="absolute top-2.5 right-2.5 w-6 h-6 rounded-full bg-amber-500/10 hover:bg-amber-500/25 text-amber-300 hover:text-white flex items-center justify-center transition-colors cursor-pointer"
            ...
            <div className="flex items-start gap-2.5 pr-6">
              ...
              <div className="space-y-1">
                <p className="font-bold text-amber-300">
                  {isKg ? 'Сайт даярдоо процессинде' : 'Сайт в процессе подготовки'}
                </p>
                <p className="text-[11px] leading-relaxed text-amber-200/90 font-medium">
                  {isKg
                    ? 'Сайт даярдоо жана иштеп чыгуу процессинде. WhatsApp, Telegram, SMS-код жана почта аркылуу кирүү азырынча иштебейт. Сураныч, Google аркылуу кириңиз.'
                    : 'Сайт в процессе подготовки и разработки. Вход через: WhatsApp, Telegram, SMS-код и код почты пока что не работает. Доступен вход через Google.'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-2.5 mb-4">
          <div className="grid grid-cols-3 gap-2">
            ...
            {/* 2. Telegram (CLICK SHOWS NOTIFICATION) */}
            <button
              type="button"
              onClick={handleTelegramClick}
              className="h-[42px] px-2 bg-[#229ED9]/80 hover:bg-[#229ED9] text-white font-bold text-xs rounded-xl shadow-md shadow-[#229ED9]/20 hover:shadow-lg transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-[0.98] border border-[#229ED9]/50"
            >
            ...
            <form onSubmit={handlePhoneFormSubmit} className="space-y-4">
              <div className="p-4 rounded-2xl bg-amber-950/40 border border-amber-500/50 text-amber-200 text-xs space-y-2">
                ...
                <p className="text-amber-200/90 leading-relaxed">
                  {isKg
                    ? 'Сайт даярдоо процессинде. SMS-код аркылуу кирүү убактылуу өчүрүлгөн. Сураныч, Google аркылуу кириңиз.'
                    : 'Сайт находится на стадии подготовки. Вход по SMS-коду временно отключен. Пожалуйста, используйте быстрый вход через Google.'}
                </p>
              </div>
